    ...
    <div class="col-md-9">
      ...
      <table class="table table-bordered" style="width: 100%;">
        ...
        <tr>
          ...
          <td> 
            <?php if($row_loai['donhang_tinhtrang']==1) {?>
            ...
            elseif ($row_loai['donhang_tinhtrang']==2) { ?>
               <a style="padding-right:10px" class="btn btn-success" href="?quanly=xemdonhang&dnh=<?php echo $row_loai["ctdonhang_id"]  ?>">Đã nhận hàng</a>  <?php } ?>
          </td>
          <td>
