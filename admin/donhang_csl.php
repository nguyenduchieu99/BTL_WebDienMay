      ...
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <td > 
            ...
            <?php } else {?>
            <a class="btn btn-success" href="?quanly=csl&xoa=<?php echo $row_loai["ctdonhang_id"]  ?>">Xóa</a>  
            <a class="btn btn-success" style="margin-left: 10px;" href="?quanly=csl&capnhap=<?php echo $row_loai["ctdonhang_id"]?>&tkh=<?php echo $row_loai["khachhang_ten"]?>">Xửa</a>  
          <?php } ?>
          </div>
          </td>
