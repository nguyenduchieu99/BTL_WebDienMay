...
<?php include_once("xemchitiet.php");  ?>
  ...
  <?php } ?>
    <div class="col-md-6 chuasuly">
      ...
      and donhang_tinhtrang=1 GROUP by ctdonhang_id,khachhang_ten,donhang_ngay,donhang_tinhtrang order by donhang_tinhtrang ");
      ?>
      <table class="table table-bordered">
        <tr>
          <th>Thứ tự</th>
        ...
        <tr>
          ...
          <td > 
            ...
            <?php if($row_loai['donhang_tinhtrang']==3 || $row_loai['donhang_tinhtrang']==2)  {?>
              <a class="btn btn-success" href="?quanly=donhang&capnhap=<?php echo $row_loai["ctdonhang_id"]?>&tkh=<?php echo $row_loai["khachhang_ten"]?>">Xem</a>  
            <?php } else {?>
            <a class="btn btn-success" href="?quanly=donhang&xoa=<?php echo $row_loai["ctdonhang_id"]  ?>">Xóa</a>  
            <a class="btn btn-success" style="margin-left: 10px;" href="?quanly=donhang&capnhap=<?php echo $row_loai["ctdonhang_id"]?>&tkh=<?php echo $row_loai["khachhang_ten"]?>">Xửa</a>  
          <?php } ?>
          </div>
          </td>
    ...
    <div class="col-md-6 dasuly">
      <h4>Danh sách đơn hàng</h4>
      <?php
      $sql_selct=mysqli_query($con,"SELECT ctdonhang_id,donhang_tinhtrang,  khachhang_ten,  donhang_ngay FROM donhang, sanpham, khachhang WHERE donhang.sanpham_id = sanpham.sanpham_id AND donhang.khachhang_id = khachhang.khachhang_id
      and donhang_tinhtrang=2 GROUP by ctdonhang_id,khachhang_ten,donhang_ngay,donhang_tinhtrang order by donhang_tinhtrang ");
      ?>
      <table class="table table-bordered">
        <tr>
          <th>Thứ tự</th>
